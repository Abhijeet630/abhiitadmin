...
WEB_API_URL_INFO = "http://172.16.17.151:5000/outlook/api/system_info"  # Endpoint to send system/PST info
WEB_API_URL_BACKUP_STATUS = "http://172.16.17.151:5000/outlook/api/backup_status"  # Endpoint to send backup status
WEB_API_URL_BACKUP_REQUEST = "http://172.16.17.151:5000/outlook/api/get_backup_request" # Endpoint to poll for backup requests
